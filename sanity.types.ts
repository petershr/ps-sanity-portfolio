...
// Query: *[_type == "home"][0]{    _id,    _type,    overview,    showcaseProjects[]{      _key,      ...@->{        _id,        _type,        coverImage,        overview,        "slug": slug.current,        title,        duration,        tags      }    },    title,  }
...
// Query: *[_type == "project" && slug.current == $slug][0] {    _id,    _type,    coverImage,    description,    duration,    gallery,    overview,    "slug": slug.current,    title,  }
